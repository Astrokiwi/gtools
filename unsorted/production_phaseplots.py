...
#     loadVals = ["TK_p","vradpoly","TK_p"]
    ...
    fig,sp = plt.subplots(2, 2, sharex='col', sharey='row', figsize=(6, 7))
    ...
    plt.suptitle(title + " t=%3.1f kyr" % (time * 1.e3))
    sp[1,1].set_ylabel("")
    ...
    cbar = plt.colorbar(mappablePlot, label=r"$\log M$ (M$_\odot$)", cax=cbar_ax, orientation='horizontal')

    # fig.tight_layout()
    plt.savefig("../figures/phaseplot_vrad_temp{}{}{}.png".format(run_id, run_name, snap_str), dpi=200)
