...
#    Binary_pos_1 = header.attrs.get("Binary_pos_1") 
#    Binary_pos_2 = header.attrs.get("Binary_pos_2")
#    Binary_mass_1= header.attrs.get("Binary_mass_1")
#    Binary_mass_2= header.attrs.get("Binary_mass_2")
...
#     if ( maxsnapf>-1 and snapf>maxsnapf ):
    ...
    with Pool(processes=nprocs) as pool:
      maps = pool.map(load_gadget,range(snapf+1-snapi))
    ...
    dist_1 = np.zeros(nfiles,dtype=float)
    dist_2 = np.zeros(nfiles,dtype=float)
